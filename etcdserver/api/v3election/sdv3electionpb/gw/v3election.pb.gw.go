...
// source: etcdserver/api/v3election/sdv3electionpb/v3election.proto

/*
Package sdv3electionpb is a reverse proxy.
...
func request_Election_Campaign_0(ctx context.Context, marshaler runtime.Marshaler, client sdv3electionpb.ElectionClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq sdv3electionpb.CampaignRequest
...
func request_Election_Proclaim_0(ctx context.Context, marshaler runtime.Marshaler, client sdv3electionpb.ElectionClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq sdv3electionpb.ProclaimRequest
	var metadata runtime.ServerMetadata
...
func request_Election_Leader_0(ctx context.Context, marshaler runtime.Marshaler, client sdv3electionpb.ElectionClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq sdv3electionpb.LeaderRequest
	var metadata runtime.ServerMetadata
...
func request_Election_Observe_0(ctx context.Context, marshaler runtime.Marshaler, client sdv3electionpb.ElectionClient, req *http.Request, pathParams map[string]string) (sdv3electionpb.Election_ObserveClient, runtime.ServerMetadata, error) {
	var protoReq sdv3electionpb.LeaderRequest
	var metadata runtime.ServerMetadata
...
func request_Election_Resign_0(ctx context.Context, marshaler runtime.Marshaler, client sdv3electionpb.ElectionClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq sdv3electionpb.ResignRequest
	var metadata runtime.ServerMetadata
...
func RegisterElectionHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterElectionHandlerClient(ctx, mux, sdv3electionpb.NewElectionClient(conn))
}
...
func RegisterElectionHandlerClient(ctx context.Context, mux *runtime.ServeMux, client sdv3electionpb.ElectionClient) error {
