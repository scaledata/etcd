...
/*
	Package sdv3lockpb is a generated protocol buffer package.
...
func (m *LockResponse) GetHeader() *sdetcdserverpb.ResponseHeader {
	if m != nil {
		return m.Header
	}
	return nil
...
func (m *UnlockResponse) GetHeader() *sdetcdserverpb.ResponseHeader {
	if m != nil {
		return m.Header
	}
	return nil
...
func init() {
	proto.RegisterType((*LockRequest)(nil), "sdv3lockpb.LockRequest")
	proto.RegisterType((*LockResponse)(nil), "sdv3lockpb.LockResponse")
	proto.RegisterType((*UnlockRequest)(nil), "sdv3lockpb.UnlockRequest")
	proto.RegisterType((*UnlockResponse)(nil), "sdv3lockpb.UnlockResponse")
}
...
func (c *lockClient) Lock(ctx context.Context, in *LockRequest, opts ...grpc.CallOption) (*LockResponse, error) {
	...
	err := grpc.Invoke(ctx, "/sdv3lockpb.Lock/Lock", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lockClient) Unlock(ctx context.Context, in *UnlockRequest, opts ...grpc.CallOption) (*UnlockResponse, error) {
	...
	err := grpc.Invoke(ctx, "/sdv3lockpb.Lock/Unlock", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Lock_Lock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sdv3lockpb.Lock/Lock",
	}
...
func _Lock_Unlock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sdv3lockpb.Lock/Unlock",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var fileDescriptorV3Lock = []byte{
	...
	,
}
