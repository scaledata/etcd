...
// source: etcdserver/api/v3lock/sdv3lockpb/v3lock.proto

/*
Package sdv3lockpb is a reverse proxy.
...
func request_Lock_Lock_0(ctx context.Context, marshaler runtime.Marshaler, client sdv3lockpb.LockClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq sdv3lockpb.LockRequest
...
func request_Lock_Unlock_0(ctx context.Context, marshaler runtime.Marshaler, client sdv3lockpb.LockClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq sdv3lockpb.UnlockRequest
	var metadata runtime.ServerMetadata
...
func RegisterLockHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterLockHandlerClient(ctx, mux, sdv3lockpb.NewLockClient(conn))
}
...
func RegisterLockHandlerClient(ctx context.Context, mux *runtime.ServeMux, client sdv3lockpb.LockClient) error {
