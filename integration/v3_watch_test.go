			...
			[]*pb.WatchResponse{
				{
					...
					Created: false,
					Events: []*sdmvccpb.Event{
						{
							Type: sdmvccpb.PUT,
							Kv:   &sdmvccpb.KeyValue{Key: []byte("foo"), Value: []byte("bar"), CreateRevision: 2, ModRevision: 2, Version: 1},
						},
					},
				},
			},
			...
			[]*pb.WatchResponse{
				{
					...
					Events: []*sdmvccpb.Event{
						{
							Type: sdmvccpb.PUT,
							Kv:   &sdmvccpb.KeyValue{Key: []byte("fooLong"), Value: []byte("bar"), CreateRevision: 2, ModRevision: 2, Version: 1},
						},
					},
				},
			},
			...
			[]*pb.WatchResponse{
				...
				},
				{
					...
					Events: []*sdmvccpb.Event{
						{
							Type: sdmvccpb.PUT,
							Kv:   &sdmvccpb.KeyValue{Key: []byte("foo"), Value: []byte("bar"), CreateRevision: 2, ModRevision: 3, Version: 2},
						},
					},
				},
				{
					...
					Events: []*sdmvccpb.Event{
						{
							Type: sdmvccpb.PUT,
							Kv:   &sdmvccpb.KeyValue{Key: []byte("foo"), Value: []byte("bar"), CreateRevision: 2, ModRevision: 4, Version: 3},
						},
					},
				},
			},
...
func TestV3WatchEmptyKey(t *testing.T) {
	...
	wevs := []*sdmvccpb.Event{
		{
			Type: sdmvccpb.PUT,
			Kv:   &sdmvccpb.KeyValue{Key: []byte("foo"), CreateRevision: 2, ModRevision: 2, Version: 1},
		},
	}
...
func testV3WatchMultipleEventsTxn(t *testing.T, startRev int64) {
	...
	wevents := []*sdmvccpb.Event{
		{
			Type: sdmvccpb.PUT,
			Kv:   &sdmvccpb.KeyValue{Key: []byte("foo0"), Value: []byte("bar"), CreateRevision: 2, ModRevision: 2, Version: 1},
		},
		{
			Type: sdmvccpb.PUT,
			Kv:   &sdmvccpb.KeyValue{Key: []byte("foo1"), Value: []byte("bar"), CreateRevision: 2, ModRevision: 2, Version: 1},
		},
		{
			Type: sdmvccpb.PUT,
			Kv:   &sdmvccpb.KeyValue{Key: []byte("foo2"), Value: []byte("bar"), CreateRevision: 2, ModRevision: 2, Version: 1},
		},
	}
...
type eventsSortByKey []*sdmvccpb.Event
...
func TestV3WatchMultipleEventsPutUnsynced(t *testing.T) {
	...
	allWevents := []*sdmvccpb.Event{
		...
		{
			Type: sdmvccpb.PUT,
			Kv:   &sdmvccpb.KeyValue{Key: []byte("foo1"), Value: []byte("bar"), CreateRevision: 3, ModRevision: 3, Version: 1},
		},
		{
			Type: sdmvccpb.PUT,
			Kv:   &sdmvccpb.KeyValue{Key: []byte("foo0"), Value: []byte("bar"), CreateRevision: 2, ModRevision: 4, Version: 2},
		},
		{
			Type: sdmvccpb.PUT,
			Kv:   &sdmvccpb.KeyValue{Key: []byte("foo1"), Value: []byte("bar"), CreateRevision: 3, ModRevision: 5, Version: 2},
		},
	}
...
func TestV3WatchWithFilter(t *testing.T) {
	...
	case resp := <-recv:
		wevs := []*sdmvccpb.Event{
			{
				Type: sdmvccpb.DELETE,
				Kv:   &sdmvccpb.KeyValue{Key: []byte("foo"), ModRevision: 3},
			},
		}
		if !reflect.DeepEqual(resp.Events, wevs) {
			t.Fatalf("got %v, expected %v", resp.Events, wevs)
