...
DIRS="./wal/sdwalpb ./etcdserver/sdetcdserverpb ./etcdserver/api/snap/sdsnappb ./raft/sdraftpb ./mvcc/sdmvccpb ./lease/sdleasepb ./auth/sdauthpb ./etcdserver/api/v3lock/sdv3lockpb ./etcdserver/api/v3election/sdv3electionpb"
