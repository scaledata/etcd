...
// source: sdrpcpb/rpc.proto

/*
	Package sdrpcpb is a generated protocol buffer package.
...
type Request struct {
	Operation Operation `protobuf:"varint,1,opt,name=Operation,proto3,enum=sdrpcpb.Operation" json:"Operation,omitempty"`
...
func init() {
	proto.RegisterType((*Request)(nil), "sdrpcpb.Request")
	proto.RegisterType((*SnapshotInfo)(nil), "sdrpcpb.SnapshotInfo")
	proto.RegisterType((*Response)(nil), "sdrpcpb.Response")
	proto.RegisterType((*Member)(nil), "sdrpcpb.Member")
	proto.RegisterType((*Tester)(nil), "sdrpcpb.Tester")
	proto.RegisterType((*Etcd)(nil), "sdrpcpb.Etcd")
	proto.RegisterEnum("sdrpcpb.Operation", Operation_name, Operation_value)
	proto.RegisterEnum("sdrpcpb.Case", Case_name, Case_value)
	proto.RegisterEnum("sdrpcpb.Stresser", Stresser_name, Stresser_value)
	proto.RegisterEnum("sdrpcpb.Checker", Checker_name, Checker_value)
}
...
func (c *transportClient) Transport(ctx context.Context, opts ...grpc.CallOption) (Transport_TransportClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Transport_serviceDesc.Streams[0], c.cc, "/sdrpcpb.Transport/Transport", opts...)
	if err != nil {
		return nil, err
	}
...
func init() { proto.RegisterFile("sdrpcpb/rpc.proto", fileDescriptorRpc) }
