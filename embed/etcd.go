...
import (
	...
	"github.com/scaledata/etcd/etcdserver/api/v2http"
	"github.com/scaledata/etcd/etcdserver/api/v2v3"
	"github.com/scaledata/etcd/etcdserver/api/v3client"
	"github.com/scaledata/etcd/etcdserver/api/v3rpc"
	"github.com/scaledata/etcd/pkg/cors"
	"github.com/scaledata/etcd/pkg/debugutil"
	runtimeutil "github.com/scaledata/etcd/pkg/runtime"
...
var plog = capnslog.NewPackageLogger("github.com/scaledata/etcd", "embed")
...
func stopServers(ctx context.Context, ss *servers) {
	...
	// and https://github.com/scaledata/etcd/issues/8916
	if ss.secure {
		shutdownNow()
		return
	}
